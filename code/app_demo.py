            ...
            with gr.Column():
                ...
                with gr.Box():
                    ...
                    with gr.Row():
                        ...
                        with gr.Column():
                            image_watermark = gr.Image(source="upload", label="Image with Watermark", interactive=True, type="numpy")
                ...
                with gr.Box():
                    ...
                    with gr.Row():
                        with gr.Column():
                            image_edit = gr.Image(source='upload',tool="sketch", label="Select Tampered Region", interactive=True, type="numpy")
                        ...
                        with gr.Column():
                            image_edited = gr.Image(source="upload", label="Tampered Result", interactive=True, type="numpy")
                ...
                with gr.Box():
                    ...
                    with gr.Row():
                        with gr.Column():
                            image_edited_1 = gr.Image(source="upload", label="Image to Extract From", interactive=True, type="numpy")
                            
                            revealing_button = gr.Button("Extract")
                        with gr.Column():
                            edit_mask = gr.Image(source='upload', label="Edit Region Mask Prediction", interactive=True, type="numpy")

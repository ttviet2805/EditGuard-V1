...
class DW_Encoder_2(nn.Module):

    def __init__(self, message_length, blocks=2, channels=64, attention=None):
        super(DW_Encoder_2, self).__init__()

        # self.conv1 = ConvBlock(3, 16, blocks=blocks)
        self.conv1 = DSConvBlock(3, 16, blocks=blocks, stride=1)
        ...
        self.Conv_message2 = DSConvBlock(1, channels, blocks=blocks, stride=1)
        ...
        self.Conv_message1 = DSConvBlock(1, channels, blocks=blocks, stride=1)
        ...
        self.Conv_message0 = DSConvBlock(1, channels, blocks=blocks, stride=1)
...
class Down(nn.Module):
    def __init__(self, in_channels, out_channels, blocks):
        ...
        # )
        self.layer = torch.nn.Sequential(
            DSConvINRelu(in_channels, in_channels, stride=2),
            DSConvBlock(in_channels, out_channels, blocks=blocks, stride=1)
        )
...
class UP(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv = DSConvBlock(in_channels, out_channels, blocks=1, stride=1)
